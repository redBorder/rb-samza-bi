...
public class FlowBeamFactory implements BeamFactory {
    ...
    public Beam<Object> makeBeam(SystemStream stream, int partitions, int replicas, Config config) {
        ...
        final List<String> dimensions = ImmutableList.of(
                ...
                CLIENT_LATLNG, COORDINATES_MAP, ASSET, ASSET_UUID,
                GATEWAY, GATEWAY_UUID, FLOOR, FLOOR_UUID, ZONE, WIRELESS_ID,
                ...
                WINDOW, CLIENT_VIP, CLIENT_LOYALITY, NETWORK_NAME, WIRELESS_STATION_NAME, GATEWAY_ID);
