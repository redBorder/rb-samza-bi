    ...
    public Beam<Object> makeBeam(SystemStream stream, int partitions, int replicas, Config config) {
        {
            ...
            final List<String> dimensions = ImmutableList.of(
                    ACTION, CLASSIFICATION, CONVERSATION, DOMAIN_NAME, ETHLENGTH_RANGE, SRC_COUNTRY, DST_COUNTRY,
                    GROUP_NAME, SIG_GENERATOR, ICMPTYPE, IPLEN_RANGE, L4_PROTO, REV, SRC_AS, DST_AS,
                    SENSOR_NAME, SENSOR_UUID, DEPLOYMENT, DEPLOYMENT_UUID, NAMESPACE, NAMESPACE_UUID, PRIORITY, MSG, SIG_ID,
                    SCATTERPLOT, ETHSRC, ETHSRC_VENDOR, LAN_IP, LAN_IP_COUNTRY_CODE, LAN_IP_NET_NAME,
                    LAN_L4_PORT, WAN_IP_AS_NAME, SRC_MAP, ETHDST, ETHDST_VENDOR, WAN_IP, WAN_IP_COUNTRY_CODE,
                    WAN_IP_NET_NAME, WAN_L4_PORT, DST_AS_NAME, DST_MAP, TOS, TTL, VLAN, DARKLIST_SCORE_NAME,
