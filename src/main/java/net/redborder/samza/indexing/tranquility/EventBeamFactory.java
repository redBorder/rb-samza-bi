...
public class EventBeamFactory implements BeamFactory
{
    ...
    public Beam<Object> makeBeam(SystemStream stream, Config config)
    {
        ...
        final List<String> dimensions = ImmutableList.of(
            ...
            MARKET, MARKET_ID, ORGANIZATION, ORGANIZATION_ID, CLIENT_LATLONG, FLOOR, FLOOR_ID, ZONE, BUILDING,
                BUILDING_ID, CAMPUS, CAMPUS_ID, WIRELESS_STATION, SHA256, FILE_SIZE, FILE_URI, FILE_HOSTNAME
        );
