    ...
    public Beam<Object> makeBeam(SystemStream stream, int partitions, int replicas, Config config) {
        {
            ...
            final List<String> dimensions = ImmutableList.of(
                    ...
                    MARKET, MARKET_UUID, ORGANIZATION, ORGANIZATION_UUID, CLIENT_LATLONG, FLOOR, FLOOR_UUID, ZONE, FOGNODE,
                    FOGNODE_UUID, ASSET, ASSET_UUID, WIRELESS_STATION, SHA256, FILE_SIZE, FILE_URI, FILE_HOSTNAME,
