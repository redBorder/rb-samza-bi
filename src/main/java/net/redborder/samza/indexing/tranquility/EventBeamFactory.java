...
public class EventBeamFactory implements BeamFactory
{
    ...
    public Beam<Object> makeBeam(SystemStream stream, Config config)
    {
        ...
        final List<String> dimensions = ImmutableList.of(
            ...
            SENSOR_NAME, SENSOR_ID, DEPLOYMENT, DEPLOYMENT_ID, NAMESPACE, NAMESPACE_ID, PRIORITY, MSG, SIG_ID,
            ...
            MARKET, MARKET_ID, ORGANIZATION, ORGANIZATION_ID, CLIENT_LATLONG, CLIENT_FLOOR, CLIENT_FLOOR_ID, CLIENT_ZONE, CLIENT_BUILDING,
            CLIENT_BUILDING_ID, CLIENT_CAMPUS, CLIENT_CAMPUS_ID, WIRELESS_STATION, SHA256, FILE_SIZE, FILE_URI, FILE_HOSTNAME
        );
