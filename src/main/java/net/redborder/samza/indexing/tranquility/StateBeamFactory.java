...
public class StateBeamFactory implements BeamFactory
{
    ...
    public Beam<Object> makeBeam(SystemStream stream, Config config)
    {
        ...
        final List<String> dimensions = ImmutableList.of(
            ...
            WIRELESS_SLOT, SENSOR_NAME, SENSOR_ID, DEPLOYMENT, DEPLOYMENT_ID, NAMESPACE, NAMESPACE_ID,
            ORGANIZATION, ORGANIZATION_ID, MARKET, MARKET_ID, CLIENT_FLOOR, CLIENT_FLOOR_ID, CLIENT_ZONE,
                CLIENT_BUILDING, CLIENT_BUILDING_ID, CLIENT_CAMPUS, CLIENT_CAMPUS_ID
        );
