...
public class Dimension {
    ...
    public final static String SRC_IP = "lan_ip";
    public final static String SENSOR_IP = "sensor_ip";
    public final static String DST_IP = "wan_ip";
    ...
    public final static String SRC_VLAN = "lan_vlan";
    public final static String DST_VLAN = "wan_vlan";
    ...
    public final static String SRC_NET_NAME = "lan_ip_net_name";
    public final static String DST_NET_NAME = "wan_ip_net_name";
    public final static String TOS = "tos";
    public final static String DST_COUNTRY_CODE = "wan_ip_as_name";
    public final static String SRC_COUNTRY_CODE = "lan_ip_country_code";
    ...
    public final static String SRC = "lan_ip";
    ...
    public final static String DST = "wan_ip";
